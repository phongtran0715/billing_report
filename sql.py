...
class Sql:
    ...
    def select(self, table, field='*', cond='', prepare={}, start=0, limit='', order_by='', direction='', group_by='',
               is_distinct=False, block=0, degug=False):
        ...
        query = str(
            select) + " " + field + " FROM " + table + " " + cond + " " + group_by + " " + order_by + " " + direction + " " + add_limit;
        # print query
